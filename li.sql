...
(1002103, 'Cameta II', 'PA'),
(1004059, 'Mãe do Rio ll', 'PA'),
(1004208, 'Marabá II', 'PA'),
(1008100, 'Tucuruí II', 'PA'),
...
(2411700, 'São Bento do Trairi', 'RN'),
...
(2515302, 'Sapé', 'PB'),
(2515401, 'SAO VICENTE DO SERIDO', 'PB'),
...
(2904050, 'Bonito', 'BA'),
(2904100, 'Boquira', 'BA'),
(2904107, 'Fortaleza dos Nogueiras II', 'MA'),
(2904209, 'Botuporã', 'BA'),
(2904308, 'Brejões', 'BA'),
...
(2929503, 'São Sebastião do Passe', 'BA'),
(2929602, 'Sapeaçu', 'BA'),
...
(3000102, 'Afonso Claudio II', 'ES'),
(3000904, 'Barra de São Francisco II', 'ES'),
(3001209, 'Cachoeiro de Itapemirim II', 'ES'),
(3001506, 'Colatina II', 'ES'),
(3001508, 'ALEM PARAIBA II', 'MG'),
(3002306, 'Guacui II', 'ES'),
(3002504, 'Ibiracu II', 'ES'),
(3003205, 'Linhares II', 'ES'),
(3003403, 'Mimoso do Sul II', 'ES'),
(3003502, 'Montanha II', 'ES'),
(3004005, 'Pancas II', 'ES'),
(3004708, 'Sao Gabriel da Palha II', 'ES'),
(3004807, 'São José do Calçado II', 'ES'),
(3039300, 'Manga II', 'MG'),
(3043906, 'Muriae II', 'MG'),
...
(3550001, 'Sao Luiz do Paraitinga', 'SP'),
...
(3900201, 'Alegre II', 'ES'),
(3901607, 'Alfenas II', 'MG'),
(3904706, 'Santo Antonio de Padua II', 'RJ'),
(3906903, 'Bicas II', 'MG'),
(3907109, 'Boa Esperança ll', 'MG'),
(3915508, 'Caxambu BB', 'MG'),
(3918007, 'Congonhas ll', 'MG'),
(3956908, 'Sacramento II', 'MG'),
(3962104, 'Sao Gotardo II', 'MG'),
(3964704, 'São Sebastião do Paraíso II', 'MG'),
(3969307, 'Três Corações ll ', 'MG'),
(3971808, 'Virginopolis BB', 'MG'),
(4002709, 'Butia II', 'RS'),
(4004309, 'Candido Godoy II', 'RS'),
(4004630, 'Capão da Canoa II', 'RS'),
(4007807, 'Estrela II', 'RS'),
(4014704, 'Planalto II', 'RS'),
(4100103, 'Abatiá', 'PR'),
...
(4901305, 'Arroio Grande ll', 'RS'),
(4903509, 'Camaquã II', 'RS'),
(4903806, 'Campinas do Sul II', 'RS'),
(4904002, 'Campo Novo II', 'RS'),
(4906809, 'Encantado II', 'RS'),
(4908508, 'Frederico Westphalen II', 'RS'),
(4910306, 'Ilópolis ll ', 'RS'),
(4911403, 'Lajeado II', 'RS'),
(4916600, 'Sananduva II', 'RS'),
(4917806, 'Santo Augusto II', 'RS'),
(4918606, 'São josé do Ouro ll', 'RS'),
(4918903, 'São Luiz Gonzaga ll', 'RS'),
(4919505, 'São Sebastião do Caí II', 'RS'),
(4920701, 'Sobradinho II', 'RS'),
(4921105, 'TAPES II', 'RS'),
(4921501, 'Torres II', 'RS'),
(4921600, 'Tramandaí II', 'RS'),
(4921901, 'Ribeirao do Pinhal II', 'PR'),
(4922806, 'Veranopolis II', 'RS'),
(5000203, 'Água Clara', 'MS'),
(5000250, 'Alta Floresta II', 'MT'),
(5000252, 'Alcinópolis', 'MS'),
(5000308, 'Alexania II', 'GO'),
(5000609, 'Amambaí', 'MS'),
...
(5001405, 'Aparecida de Goiania II', 'GO'),
...
(5008600, 'Vila Rica II', 'MT'),
(5008608, 'Goianésia ll', 'GO'),
(5015702, 'Palmeiras de Goiás ll', 'GO'),
(5100102, 'Acorizal', 'MT'),
(5100201, 'Água Boa', 'MT'),
...
(5300108, 'BRASILIA', 'DF'),
(5900258, 'Aguas Lindas de Goias II', 'GO'),
(5900803, 'Alvorada do Norte ll ', 'GO'),
(5901306, 'Anicuns ll', 'GO'),
(5903906, 'Buriti Alegre II', 'GO'),
(5905000, 'Carmo do Rio Verde II', 'GO'),
(5905681, 'Mundo Novo II', 'MS'),
(5906309, 'Paranaiba II', 'MS'),
(5908004, 'Formosa ll', 'GO'),
(5909903, 'Iaciara II', 'GO'),
(5910000, 'Inhumas ll', 'GO'),
(5911800, 'Jaraguá ll', 'GO'),
(5912808, 'Mara Rosa II', 'GO'),
(5914002, 'Mozarlândia ll', 'GO'),
(5916403, 'Parauna II', 'GO'),
(5917708, 'Pontalina ll', 'GO'),
(5920108, 'São Luís de Montes Belos II', 'GO'),
(5920207, 'São Miguel do Araguaia ll', 'GO'),
(5920405, 'Sao Simao II', 'GO'),
(5920603, 'Silvânia ll', 'GO');
...
CREATE TABLE `processos` (
  `num_processo` varchar(40) COLLATE latin1_general_ci NOT NULL,
  `data_distrib` date NOT NULL,
  `reu_principal` varchar(255) COLLATE latin1_general_ci NOT NULL,
  `valor_causa` float(10,2) NOT NULL,
  `vara` varchar(40) COLLATE latin1_general_ci NOT NULL,
...
CREATE TABLE `processos_pedidos` (
  ...
  `valor_risco_provavel` float(10,2) NOT NULL,
...
--
-- Indexes for table `processos_pedidos`
--
ALTER TABLE `processos_pedidos`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `processos_pedidos_tipos`
--
ALTER TABLE `processos_pedidos_tipos`
  ADD PRIMARY KEY (`id`);
